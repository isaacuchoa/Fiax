    ...
    <td valign="top"><form id="frmLogin" name="frmLogin" method="post" action="classe/LoginSistema.php">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td height="30" colspan="2" align="center" id="logoadm" class="titulos"></td>
        </tr>
        <br>
        </tr>
        ...
        <tr>
          ...
          <td width="83%" height="30"><input name="txtUsuario" type="text" id="txtUsuario"  size="25" maxlength="100" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="30" colspan="2" align="center"><input type="submit" name="btLogin" id="btLogin" value="Logar" />
            <input name="txtLocal" type="hidden" id="txtLocal" value="frmLogin" /></td>
        </tr>
        <tr>
          <td height="30" colspan="2" align="center"><a href="http://www.fiax.com.br" target="_blank" class="style4">voltar para o site</a></td>
        </tr>
        <tr>
